...
<template>
    <div v-if="totalPages >  1" class="flex items-center gap-4">
        ...
        class="bg-button text-btn-text fill-btn-text font-text p-3 text-sm flex items-center justify-center rounded-sm disabled:opacity-60 disabled:cursor-not-allowed transition duration-300 hover:bg-btn-hover hover:cursor-pointer" :class="[currentPage === 1 ? 'fill-text' : 'fill-btn-text']">
        ...
        <div class="flex items-center gap-2">
          ...
          class="hover:cursor-pointer text-btn-text font-text font-medium flex-none p-2 px-3 text-sm flex items-center justify-center rounded-sm disabled:opacity-60 disabled:cursor-not-allowed transition duration-300" :class="[currentPage === page ? 'bg-blue-500 text-white hover:bg-blue-600' : 'bg-button text-btn-text']">
          {{ page }}
          </button>
        </div>
        ...
        class="bg-button text-btn-text fill-btn-text font-text p-3 text-sm flex items-center justify-center rounded-sm disabled:opacity-60 disabled:cursor-not-allowed transition duration-300 hover:bg-btn-hover hover:cursor-pointer" :class="[currentPage === totalPages ? 'fill-text' : 'fill-btn-text']">
            <svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="currentColor">
