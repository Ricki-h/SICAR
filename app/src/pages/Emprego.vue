    ...
    <main class="mb-25">
        ...
        <div v-if="emprego" class="flex flex-col gap-4">
            <div class="relative">
                ...
                <div class="lg:max-w-360 mx-auto px-6 sm:px-12 lg:px-28 mb-25 flex absolute bottom-[-30px]">
                    <img :src="emprego.Icone" alt="" class="w-40 border-10 p-2 border-blue-900 rounded-full bg-[#FAFAFA]">
                </div>
                <div class="w-full flex lg:max-w-360 mx-auto px-6 sm:px-12 lg:px-28 mb-25 justify-end mt-4">
